...
interface GetPopularMoviesUseCase {
    suspend operator fun invoke(params: Params): Flow<PagingData<Movie>>
...
class GetPopularMoviesUseCaseImpl @Inject constructor(
    ...
    override suspend fun invoke(params: GetPopularMoviesUseCase.Params): Flow<PagingData<Movie>> {
        return try {
